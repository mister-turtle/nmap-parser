// This file was taken from https://github.com/lair-framework/go-nmap/blob/master/nmap.go
// full credit goes to the authors Tom Steele and contributors to the project.
...
// Parse takes a reader and unmarshals it into an NmapRun struct. All elements are returned as strings, it is up to the caller to check and cast them to the proper type.
